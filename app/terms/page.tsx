...
export const metadata: Metadata = {
  title: 'Terms and Conditions | Practa AI',
  description: 'Terms and Conditions for Practa AI - AI-powered sales training platform',
};
      ...
      <div className="mx-auto max-w-4xl px-6 py-12">
        <div className="prose prose-invert prose-emerald max-w-none">
          ...
          <div className="space-y-6 text-white/80">
            <h2 className="text-2xl font-bold text-white mt-8 mb-4">AGREEMENT TO OUR LEGAL TERMS</h2>

            <p>
              We are <strong className="text-white">Niko Tadic</strong>, doing business as{' '}
              <strong className="text-white">Practa AI</strong> ("<strong>Company</strong>," "<strong>we</strong>," "
              <strong>us</strong>," or "<strong>our</strong>"), a company registered in{' '}
              <strong className="text-white">Croatia</strong> at{' '}
              <strong className="text-white">Ulica Stjepana Gradica 13</strong>,{' '}
              <strong className="text-white">Zagreb</strong>,{' '}
              <strong className="text-white">Grad Zagreb 10010</strong>.
            </p>
            ...
            <p>
              ...
              link to these legal terms (the "<strong>Legal Terms</strong>") (collectively, the "<strong>Services</strong>").
            </p>

            <p>
              <strong className="text-white">
                Practa AI is an AI-powered sales training platform where users practice realistic sales
                conversations with adaptive AI prospects. Users engage in text-based role-play sessions and
                receive detailed post-call feedback on skills like discovery, objection handling, value
                communication, and closing.
              </strong>
            </p>

            <p>
              You can contact us by phone at <strong className="text-white">385--097-7092-605</strong>, email at{' '}
              <a href="mailto:ntadic1804@gmail.com" className="text-emerald-400 hover:underline">
                ntadic1804@gmail.com
              </a>
              , or by mail to <strong className="text-white">Ulica Stjepana Gradica 13</strong>,{' '}
              <strong className="text-white">Zagreb</strong>,{' '}
              <strong className="text-white">Grad Zagreb 10010</strong>,{' '}
              <strong className="text-white">Croatia</strong>.
            </p>

            <p>
              These Legal Terms constitute a legally binding agreement made between you, whether personally or
              on behalf of an entity ("<strong>you</strong>"), and <strong className="text-white">Niko Tadic</strong>
            ...
            <p>
              ...
              Changes to these Legal Terms will become effective{' '}
              <strong className="text-white">thirty (30)</strong> days after the notice is given, except if the
              changes apply to <strong className="text-white">a court order</strong>, and{' '}
              <strong className="text-white">security updates</strong>, in which case the changes will be effective
              immediately. By continuing to use the Services after the effective date of any changes, you agree
              to be bound by the modified terms. If you disagree with such changes, you may terminate Services as
              per the section <a href="#terms" className="text-emerald-400 hover:underline">TERM AND TERMINATION</a>
              .
            </p>
            ...
            <h2 className="text-2xl font-bold text-white mt-8 mb-4">TABLE OF CONTENTS</h2>
            ...
            <ol className="list-decimal pl-6 space-y-1">
              ...
              <li>
                <a href="#ip" className="text-emerald-400 hover:underline">
                  INTELLECTUAL PROPERTY RIGHTS
                </a>
              </li>
              <li>
                <a href="#userreps" className="text-emerald-400 hover:underline">
                  USER REPRESENTATIONS
                </a>
              </li>
              <li>
                <a href="#userreg" className="text-emerald-400 hover:underline">
                  USER REGISTRATION
                </a>
              </li>
              <li>
                <a href="#purchases" className="text-emerald-400 hover:underline">
                  PURCHASES AND PAYMENT
                </a>
              </li>
              <li>
                <a href="#subscriptions" className="text-emerald-400 hover:underline">
                  SUBSCRIPTIONS
                </a>
              </li>
              <li>
                <a href="#prohibited" className="text-emerald-400 hover:underline">
                  PROHIBITED ACTIVITIES
                </a>
              </li>
              <li>
                <a href="#ugc" className="text-emerald-400 hover:underline">
                  USER GENERATED CONTRIBUTIONS
                </a>
              </li>
              <li>
                <a href="#license" className="text-emerald-400 hover:underline">
                  CONTRIBUTION LICENSE
                </a>
              </li>
              <li>
                <a href="#thirdparty" className="text-emerald-400 hover:underline">
                  THIRD-PARTY WEBSITES AND CONTENT
                </a>
              </li>
              <li>
                <a href="#sitemanage" className="text-emerald-400 hover:underline">
                  SERVICES MANAGEMENT
                </a>
              </li>
              <li>
                <a href="#ppyes" className="text-emerald-400 hover:underline">
                  PRIVACY POLICY
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#modifications" className="text-emerald-400 hover:underline">
                  MODIFICATIONS AND INTERRUPTIONS
                </a>
              </li>
              <li>
                <a href="#law" className="text-emerald-400 hover:underline">
                  GOVERNING LAW
                </a>
              </li>
              <li>
                <a href="#disputes" className="text-emerald-400 hover:underline">
                  DISPUTE RESOLUTION
                </a>
              </li>
              <li>
                <a href="#corrections" className="text-emerald-400 hover:underline">
                  CORRECTIONS
                </a>
              </li>
              <li>
                <a href="#disclaimer" className="text-emerald-400 hover:underline">
                  DISCLAIMER
                </a>
              </li>
              <li>
                <a href="#liability" className="text-emerald-400 hover:underline">
                  LIMITATIONS OF LIABILITY
                </a>
              </li>
              <li>
                <a href="#indemnification" className="text-emerald-400 hover:underline">
                  INDEMNIFICATION
                </a>
              </li>
              <li>
                <a href="#userdata" className="text-emerald-400 hover:underline">
                  USER DATA
                </a>
              </li>
              <li>
                <a href="#electronic" className="text-emerald-400 hover:underline">
                  ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES
                </a>
              </li>
              <li>
                <a href="#california" className="text-emerald-400 hover:underline">
                  CALIFORNIA USERS AND RESIDENTS
                </a>
              </li>
              <li>
                <a href="#misc" className="text-emerald-400 hover:underline">
                  MISCELLANEOUS
                </a>
              </li>
              <li>
            ...
            <h2 id="services" className="text-2xl font-bold text-white mt-8 mb-4">
              1. OUR SERVICES
            </h2>
            ...
            <h2 id="ip" className="text-2xl font-bold text-white mt-8 mb-4">
              2. INTELLECTUAL PROPERTY RIGHTS
            </h2>

            <h3 className="text-xl font-semibold text-white mt-6 mb-3">Our intellectual property</h3>
            ...
            <h3 className="text-xl font-semibold text-white mt-6 mb-3">Your use of our Services</h3>
            ...
            <h3 className="text-xl font-semibold text-white mt-6 mb-3">Your submissions</h3>
            ...
            <p>
              ...
              and be entitled to its unrestricted use and dissemination for any lawful purpose, commercial or
            ...
            <h2 id="userreps" className="text-2xl font-bold text-white mt-8 mb-4">
            ...
            <h2 id="userreg" className="text-2xl font-bold text-white mt-8 mb-4">
              4. USER REGISTRATION
            </h2>
            ...
            <h2 id="purchases" className="text-2xl font-bold text-white mt-8 mb-4">
            ...
            <p className="mt-4">
              ...
              information, including email address, credit card numbers, and expiration dates, so that we can
            ...
            <h2 id="subscriptions" className="text-2xl font-bold text-white mt-8 mb-4">
              6. SUBSCRIPTIONS
            </h2>

            <h3 className="text-xl font-semibold text-white mt-6 mb-3">Billing and Renewal</h3>

            <p>
              Your subscription will continue and automatically renew unless canceled. You consent to our
              charging your payment method on a recurring basis for the applicable subscription fees plus any
              applicable taxes until you cancel your subscription. Cancellation takes effect at the end of the
            ...
            <p>
              ...
              will take effect at the end of the current paid term. If you have any questions or are unsatisfied
            ...
            <h3 className="text-xl font-semibold text-white mt-6 mb-3">Fee Changes</h3>
            ...
            <h3 className="text-xl font-semibold text-white mt-6 mb-3">Refunds</h3>

            <p>
              You may ask for a refund within 14 days of purchase. For refunds, please contact{' '}
              <a href="mailto:ntadic1804@gmail.com" className="text-emerald-400 hover:underline">
                ntadic1804@gmail.com
              </a>
              .
            ...
            <h2 id="prohibited" className="text-2xl font-bold text-white mt-8 mb-4">
            ...
            <h2 id="ugc" className="text-2xl font-bold text-white mt-8 mb-4">
            ...
            <p>
              ...
              to us or on the Services, including but not limited to text, writings, video, audio,
            ...
            <h2 id="license" className="text-2xl font-bold text-white mt-8 mb-4">
            ...
            <h2 id="thirdparty" className="text-2xl font-bold text-white mt-8 mb-4">
            ...
            <p>
              ...
              services offered on Third-Party Websites and you shall hold us blameless from any harm caused
              by your purchase of such products or services. Additionally, you shall hold us blameless from
              any losses sustained by you or harm caused to you relating to or resulting in any way from any
              Third-Party Content or any contact with Third-Party Websites.
            </p>

            <h2 id="sitemanage" className="text-2xl font-bold text-white mt-8 mb-4">
            ...
            <h2 id="ppyes" className="text-2xl font-bold text-white mt-8 mb-4">
              12. PRIVACY POLICY
            </h2>
            ...
            <p>
              ...
              <a
                href="https://practa-ai.vercel.app/privacy"
                className="text-emerald-400 hover:underline"
                target="_blank"
                rel="noopener noreferrer"
              >
                https://practa-ai.vercel.app/privacy
              </a>
              ...
              <strong className="text-white">Croatia</strong> and{' '}
              <strong className="text-white">United States</strong>. If you access the Services from any
              ...
              <strong className="text-white">Croatia</strong> and{' '}
              <strong className="text-white">United States</strong>, then through your continued use of the
              Services, you are transferring your data to <strong className="text-white">Croatia</strong> and{' '}
              <strong className="text-white">United States</strong>, and you expressly consent to have your
              data transferred to and processed in <strong className="text-white">Croatia</strong> and{' '}
              <strong className="text-white">United States</strong>.
            </p>

            <h2 id="terms" className="text-2xl font-bold text-white mt-8 mb-4">
            ...
            <p>
              ...
              PARTICIPATION IN THE SERVICES OR DELETE YOUR ACCOUNT AND ANY CONTENT OR INFORMATION THAT YOU
            ...
            <h2 id="modifications" className="text-2xl font-bold text-white mt-8 mb-4">
            ...
            <p>
              ...
              of the Services. Nothing in these Legal Terms will be construed to obligate us to maintain
              and support the Services or to supply any corrections, updates, or releases in connection
              therewith.
            </p>

            <h2 id="law" className="text-2xl font-bold text-white mt-8 mb-4">
              15. GOVERNING LAW
            </h2>

            <p>
              These Legal Terms are governed by and interpreted following the laws of{' '}
              <strong className="text-white">Croatia</strong>, and the use of the United Nations Convention of
              Contracts for the International Sales of Goods is expressly excluded. If your habitual
              residence is in the EU, and you are a consumer, you additionally possess the protection
              provided to you by obligatory provisions of the law in your country to residence.{' '}
              <strong className="text-white">Niko Tadic</strong> and yourself both agree to submit to the
              non-exclusive jurisdiction of the courts of <strong className="text-white">Zagreb</strong>,
              which means that you may make a claim to defend your consumer protection rights in regards to
              these Legal Terms in <strong className="text-white">Croatia</strong>, or in the EU country in
              which you reside.
            </p>

            <h2 id="disputes" className="text-2xl font-bold text-white mt-8 mb-4">
              16. DISPUTE RESOLUTION
            </h2>

            <h3 className="text-xl font-semibold text-white mt-6 mb-3">Informal Negotiations</h3>
            ...
            <p>
              ...
              for at least <strong className="text-white">thirty (30)</strong> days before initiating
              arbitration. Such informal negotiations commence upon written notice from one Party to the
              other Party.
            </p>

            <h3 className="text-xl font-semibold text-white mt-6 mb-3">Binding Arbitration</h3>
            ...
            <p>
              ...
              arbitration shall be <strong className="text-white">Zagreb</strong>,{' '}
              <strong className="text-white">Croatia</strong>. The language of the proceedings shall be{' '}
              <strong className="text-white">English</strong>. Applicable rules of substantive law shall be
              the law of <strong className="text-white">Croatia</strong>.
            </p>

            <h3 className="text-xl font-semibold text-white mt-6 mb-3">Restrictions</h3>
            ...
            <p>
              ...
              protect, or concerning the validity of, any of the intellectual property rights of a Party; (b)
            ...
            <h2 id="corrections" className="text-2xl font-bold text-white mt-8 mb-4">
              17. CORRECTIONS
            </h2>
            ...
            <h2 id="disclaimer" className="text-2xl font-bold text-white mt-8 mb-4">
              18. DISCLAIMER
            </h2>
            ...
            <p>
              ...
              IN ANY CONTENT AND MATERIALS OR FOR ANY LOSS OR DAMAGE OF ANY KIND INCURRED AS A RESULT OF
              THE USE OF ANY CONTENT POSTED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA THE SERVICES. WE
            ...
            <h2 id="liability" className="text-2xl font-bold text-white mt-8 mb-4">
            ...
            <p>
              ...
              AMOUNT PAID, IF ANY, BY YOU TO US DURING THE{' '}
              <strong className="text-white">SIX (6)</strong> MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION
            ...
            <h2 id="indemnification" className="text-2xl font-bold text-white mt-8 mb-4">
              20. INDEMNIFICATION
            </h2>
            ...
            <h2 id="userdata" className="text-2xl font-bold text-white mt-8 mb-4">
              21. USER DATA
            </h2>
            ...
            <h2 id="electronic" className="text-2xl font-bold text-white mt-8 mb-4">
            ...
            <h2 id="california" className="text-2xl font-bold text-white mt-8 mb-4">
            ...
            <h2 id="misc" className="text-2xl font-bold text-white mt-8 mb-4">
              24. MISCELLANEOUS
            </h2>
            ...
            <div className="mt-4 space-y-1">
              ...
              <p>Croatia</p>
              <p>
                Phone: <span className="text-white">385--097-7092-605</span>
              </p>
              <p>
                <a href="mailto:ntadic1804@gmail.com" className="text-emerald-400 hover:underline">
                  ntadic1804@gmail.com
